...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Job Applicants on Job ID :<s:property value="job_no"/> </span></h2>
		<a href="allJob.action"><--Back to List</a> 
      ...
      <s:if test="test!=null">
          <table width="100%">
          	...
          	<s:else>
          		...
          		<a href="purchaseResume.action?resume_no=<s:property value='resume_no'/>">Purchase Resume | </a>
                <a href="saveResume.action?resume_no=<s:property value='resume_no'/>">Save Resume</a>          		
          		</td>
          	</tr>
          	</s:iterator>
          </table>
