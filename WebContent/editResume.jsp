...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Edit Resume</span></h2><hr/>
	          <s:if test='#session.resume=="notcreated"'><a href="createResume.action">Create</a> |</s:if>
	          <s:else><a href="editResume.action">Edit Resume</a> | </s:else>
	          <a href="downloadResume.action">Download PDF Version</a>
          <hr/><s:form method="post" action="editSaveResume" theme="simple">
          <ol>
          <s:hidden name="resume_no"/>
          <li>
          	<label >Title *</label>
           ...
           <table width="100%">
			...
			<s:iterator value="model" status="rowStatus">
				<tr style="background-color: #F0F8FF; color: navy;">
				    <s:hidden name="model[%{#rowStatus.index}].resume_qualification_no"/>
		  ...
		  <li>
            <label > Skills*</label>
            <s:textfield id="skills" name="skills" theme="simple"/>
          </li> 
