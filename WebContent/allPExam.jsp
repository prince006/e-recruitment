...
<div class="mainbar">
<div class="article">
<h2><span>Purchased Online Exam</span></h2><hr/>
...
<table width="100%">
	...
	<s:iterator value="examList" status="pojo">
		...
		<a href="editExam.action?action=editp&exam_no=<s:property value='exam_no'/>">Edit Exam |</a>
		<a href="examQAdd.action?action=showp&exam_no=<s:property value='exam_no'/>">View Questions</a>
		<a href="clearedUser.action?link=allPExam.action&exam_no=<s:property value='exam_no'/>">Cleared User</a>
		</td>
		</tr>
	</s:iterator>
</table>
