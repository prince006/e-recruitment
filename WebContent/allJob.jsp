...
<div class="mainbar">
<div class="article">
<h2><span>Available Requirement</span></h2><hr/>
<a href="createJob.action">Create</a> | <a href="searchJob.action">Search</a>
| <a href="allJob.action">List</a><hr/>
...
<table width="100%">
	...
	<s:iterator value="jobList" status="pojo">
		...
		<td style="text-align: center;">
		    <a href="editJob.action?action=edit&job_no=<s:property value='job_no'/>">Edit |</a>
		    <a href="viewApplicants.action?action=applicants&job_no=<s:property value='job_no'/>">View Applicants</a>
 		 </td>
		</tr>
	</s:iterator>
</table>
